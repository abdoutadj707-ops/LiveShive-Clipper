...
function App(){
  ...
  async function autopilot(){
    ...
    if(!engine?.configured){
      ...
      setStatus("LiveShive is ready, but the private AI Engine is not connected. Start START-LIVESHIVE-AI.bat, then save your OpenAI API key in the PRIVATE AI ENGINE box.");
      return;
    }
